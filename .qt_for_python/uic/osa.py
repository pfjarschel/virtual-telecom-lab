...
# Form implementation generated from reading ui file 'd:\Stuff\SideWorks\VirtualTelecomLab\instruments\osa.ui'
#
...
class Ui_OSA(object):
    def setupUi(self, OSA):
        OSA.setObjectName("OSA")
        OSA.resize(926, 537)
        self.gridLayout = QtWidgets.QGridLayout(OSA)
        ...
        self.startBut = QtWidgets.QPushButton(OSA)
        ...
        self.stopBut = QtWidgets.QPushButton(OSA)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.singleBut = QtWidgets.QPushButton(OSA)
        ...
        self.groupBox = QtWidgets.QGroupBox(OSA)
        ...
        self.spanSpin.setMinimum(0.01)
        self.spanSpin.setMaximum(1700.0)
        self.spanSpin.setProperty("value", 1700.0)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(OSA)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(OSA)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout.addWidget(self.sgNSpin)
        ...
        self.pointsSpin.setMaximum(100000)
        ...
        self.rbwSpin.setDecimals(2)
        self.rbwSpin.setMinimum(0.01)
        self.rbwSpin.setMaximum(2.0)
        self.rbwSpin.setSingleStep(0.1)
        self.rbwSpin.setProperty("value", 1.0)
        ...
        self.verticalLayout_3.addWidget(self.peakCheck)
        ...
        self.saveBut = QtWidgets.QPushButton(OSA)
        ...
        self.tabWidget = QtWidgets.QTabWidget(OSA)
        ...
        self.retranslateUi(OSA)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(OSA)

    def retranslateUi(self, OSA):
        _translate = QtCore.QCoreApplication.translate
        OSA.setWindowTitle(_translate("OSA", "OSA - Virtual Telecom Lab"))
        self.startBut.setText(_translate("OSA", "Run"))
        self.stopBut.setText(_translate("OSA", "Stop"))
        self.singleBut.setText(_translate("OSA", "Single"))
        self.groupBox.setTitle(_translate("OSA", "Horizontal Control"))
        self.label_2.setText(_translate("OSA", "Stop (nm)"))
        self.label.setText(_translate("OSA", "Start (nm)"))
        self.label_4.setText(_translate("OSA", "Span (nm)"))
        self.label_3.setText(_translate("OSA", "Center (nm)"))
        self.groupBox_2.setTitle(_translate("OSA", "Vertical Control"))
        self.dbmRadio.setText(_translate("OSA", "dBm"))
        self.linRadio.setText(_translate("OSA", "Linear (Auto)"))
        self.label_7.setText(_translate("OSA", "dB/Div"))
        self.label_8.setText(_translate("OSA", "Ref level (dBm)"))
        self.groupBox_3.setTitle(_translate("OSA", "Acquisition Control"))
        self.label_6.setText(_translate("OSA", "Spectrogram N"))
        self.label_15.setText(_translate("OSA", "Points"))
        self.label_16.setText(_translate("OSA", "Averages"))
        self.label_5.setText(_translate("OSA", "RBW (nm)"))
        self.peakCheck.setText(_translate("OSA", "Peak detection"))
        self.saveBut.setText(_translate("OSA", "Save"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.normal), _translate("OSA", "Normal"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.spectrogram), _translate("OSA", "Spectrogram"))
