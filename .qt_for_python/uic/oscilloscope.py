...
class Ui_Oscilloscope(object):
    def setupUi(self, Oscilloscope):
        ...
        self.showvdivCheck = QtWidgets.QCheckBox(Oscilloscope)
        self.showvdivCheck.setChecked(True)
        self.showvdivCheck.setObjectName("showvdivCheck")
        self.verticalLayout_9.addWidget(self.showvdivCheck)
    ...
    def retranslateUi(self, Oscilloscope):
        ...
        self.showvdivCheck.setText(_translate("Oscilloscope", "Show vertical numbers (divisions, NOT Volts)"))
